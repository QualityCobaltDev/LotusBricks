...
export default function DevelopersPage() {
  return (
    <Section className="py-10">
      <h1 className="text-3xl font-bold text-neutral-900 md:text-4xl">Developer launch channel</h1>
      ...
      <div className="mt-6 grid gap-4 md:grid-cols-2">
        <article className="rounded-xl border border-neutral-200 bg-white p-4">
          <h2 className="text-lg font-semibold text-neutral-900">Project visibility</h2>
          <p className="mt-2 text-sm text-neutral-700">Feature your project with branded pages and curated listing placements.</p>
        </article>
        <article className="rounded-xl border border-neutral-200 bg-white p-4">
          <h2 className="text-lg font-semibold text-neutral-900">Demand qualification</h2>
          <p className="mt-2 text-sm text-neutral-700">Capture and segment buyer leads by budget, unit type, and timeline.</p>
        </article>
      </div>
